...
@Component({
  selector: 'app-c-ingreso-devoluciones',
  templateUrl: './c-ingreso-devoluciones.component.html',
  styleUrls: ['./c-ingreso-devoluciones.component.scss']
})
export class CIngresosDevolucionesComponent implements OnInit, OnDestroy{
    ...
    onNuevo() {        
      this.tituloDetalle = "REGISTRAR INGRESO POR DEVOLUCIÓN";
      this.dataDet = {
        idcodigo: 0,
        paramReg:'N',
        idtipodocprc: 23
