...
@Component({
  selector: 'app-c-detalledevoluciones',
  templateUrl: './c-detalledevoluciones.component.html',
  styleUrls: ['./c-detalledevoluciones.component.scss']
})
export class CDetalleDevolucionComponent implements OnInit, OnDestroy {
  @Input() IA_data: any;
  ...
  createFormRegistro() {
    ...
    this.registerFormRegistro = this.formBuilder.group({
      ...
      tipomovimiento: [{ value: 582, disabled: false }],
    });
  }
