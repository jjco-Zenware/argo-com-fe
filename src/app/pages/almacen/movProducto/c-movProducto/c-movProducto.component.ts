...
@Component({
  selector: 'app-c-movProducto',
  templateUrl: './c-movProducto.component.html',
  styleUrls: ['./c-movProducto.component.scss']
})
export class CMovProductoComponent implements OnInit, OnDestroy{
    ...
    frmDatos!: FormGroup;
    lstProducto:any;
    tituloKardex: string = 'CONSULTA DE MOVIMIENTO';
    idprod: any;
    lstOrigen: any;
    lstProyectos: any;
    lstOrdenC: any;
    ...
    listaProyectoTipo(){
      ...
      listaMovimientosPrc(){
        const $listaMovimientos = this.proyectosService.listarMovimientosPrc().subscribe({
          next: (rpta: any) => {
            this.lstMovimiento = rpta;
            const obj = {
              idtipodocprc : 0,
              nomtipodocprc: 'TODOS'
            }
            this.lstMovimiento.unshift(obj);
          },
          error: (err) => {
            this.serviceSharedApp.messageToast()
          },
        ...
        this.$listSubcription.push($listaMovimientos);
      }
}
