...
@Component({
  selector: 'app-c-ajustescab',
  templateUrl: './c-ajustescab.component.html',
  styleUrls: ['./c-ajustescab.component.scss']
})
export class CAjustescabComponent implements OnInit, OnDestroy{
    ...
    onNuevo() {        
      this.tituloDetalle = "REGISTRAR AJUSTE DE INVENTARIO";
      this.dataDet = {
        idcodigo: 0,
        paramReg:'N',
        idtipodocprc: 26
    ...
    getExportarExcel(data :any) {
      ...
      import('xlsx').then((xlsx) => {
        ...
        this.saveAsExcelFile(excelBuffer, 'Ajustes de Inventarios');
        });
      }
