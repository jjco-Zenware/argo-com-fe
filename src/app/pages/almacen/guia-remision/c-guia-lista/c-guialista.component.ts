...
@Component({
  selector: 'app-c-guialista',
  templateUrl: './c-guialista.component.html',
  styleUrls: ['./c-guialista.component.scss']
})
export class CGuiaRemisionListaComponent implements OnInit, OnDestroy{
    ...
    onVer(dato: any) {
        ...
        this.tituloDetalle =  'N° GUIA DE REMISIÓN - '+ dato.idordencompra;
        this.dataDet = {
    ...
    onNuevo() {        
      this.tituloDetalle = "REGISTRAR GUIA DE REMISIÓN";
      this.dataDet = {
        idcodigo: 0,
        paramReg:'N',
        idtipodocprc: 27
