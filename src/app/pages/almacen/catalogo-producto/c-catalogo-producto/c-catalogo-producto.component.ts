...
@Component({
  selector: 'app-c-catalogo-producto',
  templateUrl: './c-catalogo-producto.component.html',
  styleUrls: ['./c-catalogo-producto.component.scss']
})

export class CCatalogoProductoComponent implements OnInit, OnDestroy{
