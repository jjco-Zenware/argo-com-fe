...
@Component({
  selector: 'app-c-salida-baja',
  templateUrl: './c-salida-baja.component.html',
  styleUrls: ['./c-salida-baja.component.scss']
})
export class CSalidaBajaComponent implements OnInit, OnDestroy{
