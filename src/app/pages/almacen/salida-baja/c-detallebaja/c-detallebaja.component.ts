...
@Component({
  selector: 'app-c-detallebaja',
  templateUrl: './c-detallebaja.component.html',
  styleUrls: ['./c-detallebaja.component.scss']
})
export class CDetalleBajaComponent implements OnInit, OnDestroy{
  @Input() IA_data: any;
