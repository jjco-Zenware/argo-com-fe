...
@Component({
  selector: 'app-c-reubicacion',
  templateUrl: './c-reubicacion.component.html',
  styleUrls: ['./c-reubicacion.component.scss']
})
export class CReubicacionComponent implements OnInit, OnDestroy{
    ...
    onVer(dato: any) {
        ...
        this.tituloDetalle =  'N° REUBICACIÓN - '+ dato.idordencompra;
        this.dataDet = {
    ...
    onNuevo() {        
      this.tituloDetalle = "REGISTRAR SALIDA POR REUBICACIÓN";
      this.dataDet = {
        idcodigo: 0,
        paramReg:'N',
        idtipodocprc: 25
