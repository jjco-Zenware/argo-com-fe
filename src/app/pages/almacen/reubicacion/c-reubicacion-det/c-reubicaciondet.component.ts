...
@Component({
  selector: 'app-c-reubicaciondet',
  templateUrl: './c-reubicaciondet.component.html',
  styleUrls: ['./c-reubicaciondet.component.scss']
})
export class CReubicacionDetComponent implements OnInit, OnDestroy{
  @Input() IA_data: any;
  ...
  validarDatos():boolean{
    ...
    console.log('this.formValue...', this.registerFormRegistro.value);
      ...
      if (!_error && (this.registerFormRegistro.value.alm_idalmacen_destino === 0 || this.registerFormRegistro.value.alm_idalmacen_destino === null))
      {
