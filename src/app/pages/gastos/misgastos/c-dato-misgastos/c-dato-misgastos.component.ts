...
@Component({
  selector: 'app-c-dato-misgastos',
  templateUrl: './c-dato-misgastos.component.html',
  styleUrls: ['./c-dato-misgastos.component.scss']
})
export class DatoMisGastosComponent implements OnInit, OnDestroy{
  @Input() IA_data: any;
