...
@Component({
  selector: 'app-c-ingreso-oc-proyecto',
  templateUrl: './c-ingreso-oc-proyecto.component.html',
  styleUrls: ['./c-ingreso-oc-proyecto.component.scss']
})
export class CIngresoOcProyectoComponent implements OnInit, OnDestroy{
    ...
    onNuevo() {        
      this.tituloDetalle = "REGISTRAR INGRESO POR COMPRAS";
      this.dataDet = {
        idcodigo: 0,
        paramReg:'N',
        idtipodocprc: 9
    ...
    getExportarExcel(data :any) {
      ...
      for (let i = 0; i < this.lstExportExcel.length; i++) {       
          const objeto = {
              ...
              'DOCUMENTO': this.lstExportExcel[i].ord_documento,
      ...
      import('xlsx').then((xlsx) => {
        ...
        this.saveAsExcelFile(excelBuffer, 'Ingreso de Proyecto');
        });
      }       
