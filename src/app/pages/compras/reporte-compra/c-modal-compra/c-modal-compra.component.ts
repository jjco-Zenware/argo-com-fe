...
@Component({
  selector: 'app-c-modal-compra',
  templateUrl: './c-modal-compra.component.html',
  styleUrls: ['./c-modal-compra.component.scss']
})
export class ModalCompraComponent implements OnInit, OnDestroy{
