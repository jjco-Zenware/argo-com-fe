...
@Component({
  selector: 'app-c-registro-proveedor',
  templateUrl: './c-registro-proveedor.component.html',
  styleUrls: ['./c-registro-proveedor.component.scss']
})

  export class CRegistroProveedorComponent implements OnInit, OnDestroy{
    ...
    onVer(data: any) {
        ...
        this.tituloDetalle = "VER PROVEEDOR" + data.razonsocial;
    ...
    EditarCliente(data: any) {
        ...
        this.tituloDetalle = "EDITAR PROVEEDOR " + data.razonsocial;
        this.vistaLista = false;
        this.visDetalle = true;
    ...
    onNuevo(data: any) {
      ...
      this.dataCT = data;
      this.tituloDetalle = "REGISTRAR NUEVO PROVEEDOR" ;
      this.vistaLista = false;
      this.visDetalle = true;
  }
    ...
    getBack() {
      ...
      getActvarDesactivar(dato:any){   
        this.confirmationService.confirm({
          ...
          message: '¿Estás seguro de Activar/Desactivar el Proveedor: '+ '<b>'+ dato.razonsocial +'</b>'+ '?',
          //icon: 'pi pi-exclamation-triangle text-6xl',
          accept: () => {
            this.activarProveedor(dato);  
          }
      }); 
        
      }

    activarProveedor(data: any){      
      this.setSpinner(true);
      const objeto = {
