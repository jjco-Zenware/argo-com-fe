...
export class DatoCompraComponent implements OnInit, OnDestroy {
            ...
            .subscribe({
                next: (rpta: any) => {
                    ...
                    this.getOportunidades(
                        rpta.ordencompra[0].idproveedor_origen
                    );
                ...
                complete: () => {
                    ...
                    this.registerFormRegistro
                        ...
                        ?.setValue(this.ordenCompra.iddocumentoprc_origen);
                    this.cargarMenu(this.ordenCompra.acciones);
                },
            });
    ...
    NuevoPersona() {
        ...
        refItem.onClose.subscribe((rpta: any) => {
            ...
            if (rpta != undefined) {
                ...
                this.registerFormRegistro
                    .get('razonsocial')
                    ?.setValue(rpta.objeto.razonsocial);
            }
        });
    }
        ...
        const $cargarOrdenC = this.ordencompraService
            ...
            .subscribe({
                next: (rpta: any) => {
                    ...
                    const filename =
                        'DET_FACT_COMPRA_' +
                        this.registerFormRegistro.value.nrofactura;
    ...
    validarDatos(): boolean {
        ...
        if (
            ...
            this.registerFormRegistro.value.idproyecto === null
        ) {
        ...
        //         this.errorMensaje =
        //             'El Monto de cuotas no debe exceder el Monto Neto Pago...!';
        //         _error = true;
        //     }
        // }
    ...
    recuperarItems() {
        let value = this.registerFormRegistro.get(
            'idordencompra_origen_ctb'
        )?.value;
        if (value === 0) {
            this.messageService.add({
                severity: 'info',
