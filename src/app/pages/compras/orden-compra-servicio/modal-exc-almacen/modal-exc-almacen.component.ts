...
@Component({
  selector: 'app-modal-exc-almacen',
  templateUrl: './modal-exc-almacen.component.html',
  styleUrls: ['./modal-exc-almacen.component.scss']
})
export class CModalExcAlmacenComponent {
