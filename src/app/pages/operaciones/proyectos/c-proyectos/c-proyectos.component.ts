...
@Component({
  selector: 'app-c-proyectos',
  templateUrl: './c-proyectos.component.html',
  styleUrls: ['./c-proyectos.component.scss']
})
export class CProyectosComponent implements OnInit, OnDestroy{
    ...
    onVer(dato: any) {
        ...
        this.tituloDetalle =  'N° PARTIDA - '+ dato.idordencompra;
        this.dataDet = {
