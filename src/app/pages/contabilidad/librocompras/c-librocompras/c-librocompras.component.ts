...
@Component({
  selector: 'app-c-librocompras',
  templateUrl: './c-librocompras.component.html',
  styleUrls: ['./c-librocompras.component.scss']
})
export class CLibroComprasComponent implements OnInit, OnDestroy{
