...
@Component({
  selector: 'app-c-activos',
  templateUrl: './c-activos.component.html',
  styleUrls: ['./c-activos.component.scss']
})
export class CActivosComponent implements OnInit, OnDestroy{
    ...
    onNuevo() {        
      this.tituloDetalle = "REGISTRAR ACTIVO ";
      this.dataDet = {
        idcodigo: 0,
        paramReg:'N'
      }
