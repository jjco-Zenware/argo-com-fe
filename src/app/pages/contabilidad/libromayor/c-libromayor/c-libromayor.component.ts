...
@Component({
  selector: 'app-c-libromayor',
  templateUrl: './c-libromayor.component.html',
  styleUrls: ['./c-libromayor.component.scss']
})
export class CLibroMayorComponent implements OnInit, OnDestroy{
