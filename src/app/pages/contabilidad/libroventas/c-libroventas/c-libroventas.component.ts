...
@Component({
  selector: 'app-c-libroventas',
  templateUrl: './c-libroventas.component.html',
  styleUrls: ['./c-libroventas.component.scss']
})
export class CLibroVentasComponent implements OnInit, OnDestroy{
