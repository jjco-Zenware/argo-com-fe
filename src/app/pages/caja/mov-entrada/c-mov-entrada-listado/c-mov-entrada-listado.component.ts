...
@Component({
  selector: 'app-c-mov-entrada-listado',
  templateUrl: './c-mov-entrada-listado.component.html',
  styleUrls: ['./c-mov-entrada-listado.component.scss']
})
export class CMovEntradaListadoComponent implements OnInit, OnDestroy {
