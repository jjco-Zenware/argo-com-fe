...
@Component({
  selector: 'app-c-mov-salida-listado',
  templateUrl: './c-mov-salida-listado.component.html',
  styleUrls: ['./c-mov-salida-listado.component.scss']
})
export class CMovSalidaListadoComponent implements OnInit, OnDestroy {
