...
import { CmRegistrarFacturacionComponent } from 'src/app/pages/hotel/reserva/cm-registrar-facturacion/cm-registrar-facturacion.component';
...
export class CRegistroVentaComponent implements OnInit, OnDestroy {
  ...
  onEditar(item: any) {
    ...
    const ref = this.dialogService.open(CmRegistrarFacturacionComponent, {
      ...
      header: `Editar Facturación ${item.nrofactura}`,
      closeOnEscape: false,
      styleClass: 'testDialog',
      width: '50%'
    });
