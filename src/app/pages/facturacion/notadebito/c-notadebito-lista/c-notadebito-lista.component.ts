...
@Component({
  ...
  templateUrl: './c-notadebito-lista.component.html',
  styleUrls: ['./c-notadebito-lista.component.scss']
})
export class CNotaDebitoComponent implements OnInit, OnDestroy{
  ...
  onVer(data: any) {
      ...
      this.tituloDetalle = "Ver Nota de Débito N° " + data.nrofactura;
  ...
  onEditar(data: any) {
      ...
      this.tituloDetalle = "Editar Nota de Débito N° " + data.nrofactura;
      this.vistaLista = false;
      this.visDetalle = true;
      this.visQuote = false;
  }
  ...
  getBack() {
    ...
    onNuevo() {        
      this.tituloDetalle = "REGISTRAR NOTA DE DÉBITO";
      this.dataPrc = {
        idordencompra: 0,
        paramReg:'N'
      }
