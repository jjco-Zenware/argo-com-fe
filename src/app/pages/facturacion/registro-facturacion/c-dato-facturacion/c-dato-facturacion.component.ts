...
@Component({
  selector: 'app-c-dato-facturacion',
  templateUrl: './c-dato-facturacion.component.html',
  styleUrls: ['./c-dato-facturacion.component.scss']
})
export class DatoFacturacionComponent implements OnInit, OnDestroy{
  @Input() IA_data: any;
