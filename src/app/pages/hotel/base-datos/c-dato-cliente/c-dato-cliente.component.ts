...
import { Cliente, TablaDetalle } from '@interfaces';
...
export class CDatoClienteComponent implements OnChanges, OnDestroy {
  ...
  cargarData() {
    ...
    if(this.IA_data.adm_fechanacimiento){
      this.registerFormCliente.get('adm_fechanacimiento')?.setValue(new Date(this.IA_data.adm_fechanacimiento));
    }
