...
import { constantesLocalStorage, mensajesSpinner, mensajesQuestion } from '@constantes';
...
@Component({
  selector: 'app-c-punto-venta-listado',
  templateUrl: './c-punto-venta-listado.component.html',
  styleUrls: ['./c-punto-venta-listado.component.scss']
})
export class CPuntoVentaListadoComponent implements OnInit, OnDestroy{
